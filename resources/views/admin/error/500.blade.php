...
<html lang="zh-TW" class="remember-theme">
  <head>
    ...
    <meta name="description" content="500 - 伺服器錯誤">
          ...
          <div class="hero-inner">
            <div class="content content-full">
              <div class="py-4 text-center">
                <div class="display-1 fw-bold text-pulse">
                  <i class="fa fa-server opacity-50 me-1"></i> 500
                </div>
                <h1 class="fw-bold mt-5 mb-2">伺服器發生錯誤，請稍後再試</h1>
