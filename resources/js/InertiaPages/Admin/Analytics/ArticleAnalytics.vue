    ...
    <div class="content">
        ...
        <div class="block block-rounded">
            <div class="block-header block-header-default">
                <h3 class="block-title">新聞分類統計</h3>
                <div class="block-options">
                    <span class="text-muted">查看各新聞分類的觀看數據與人口統計分析</span>
                </div>
            </div>
        </div>
        ...
        <AnalyticsTabs :tabs="tabList" @tab-changed="handleTabChange">
            ...
            <template #tab-0>
                <GenderViewsTab
                    ...
                    :dateRange="dateRange"
                    routeName="admin.analytics.articles"
                />
            </template>
