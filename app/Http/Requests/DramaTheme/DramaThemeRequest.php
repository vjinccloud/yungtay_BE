...
namespace App\Http\Requests\DramaTheme;

use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Validation\Rule;

class DramaThemeRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'drama_id' => [
                ...
                'integer',
                'exists:dramas,id',
                 // 條件唯一：在同一 theme_id 下 drama_id 不可重複
                 $isUpdate
                    ? Rule::unique('drama_theme_relations', 'drama_id')
    ...
    {
        return [
            'drama_id.unique' => '此影音已在該主題中，請選擇其他影音',
            ...
            'drama_id.required' => '請選擇影音',
            'drama_id.exists' => '選擇的影音不存在'
        ];
    }
