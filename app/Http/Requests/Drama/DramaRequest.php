...
namespace App\Http\Requests\Drama;
...
class DramaRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $drama = $isUpdate
            ? Drama::with(['posterDesktop','posterMobile', 'bannerDesktop', 'bannerMobile'])->find($id)
            : null;
        ...
        $hasDesktop = $isUpdate
            && ! $desktopCleared
            && optional($drama->posterDesktop)->exists;
        $hasMobile  = $isUpdate
            && ! $mobileCleared
            && optional($drama->posterMobile)->exists;
        $hasBannerDesktop = $isUpdate
            && ! $bannerDesktopCleared
            && optional($drama->bannerDesktop)->exists;
        $hasBannerMobile = $isUpdate
            && ! $bannerMobileCleared
            && optional($drama->bannerMobile)->exists;
