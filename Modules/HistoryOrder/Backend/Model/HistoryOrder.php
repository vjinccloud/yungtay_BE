...
class HistoryOrder extends Model
{
    ...
    public static function getCabinSpecFields(): array
    {
        return [
            ...
            'side_panel_left'  => ['label' => '左側板', 'icon' => '/images/icon_14.png'],
            'side_panel_right' => ['label' => '右側板', 'icon' => '/images/icon_13.png'],
            'side_panel_back'  => ['label' => '後側板', 'icon' => '/images/icon_15.png'],
            'side_panel_front' => ['label' => '前側板', 'icon' => '/images/icon_16.png'],
