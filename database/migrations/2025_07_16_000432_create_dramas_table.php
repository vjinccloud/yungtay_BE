...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('dramas', function (Blueprint $table) {
            ...
            // 分類與基本設定
            $table->foreignId('category_id')->constrained('categories')->onDelete('cascade')->comment('影音主分類ID');
            $table->foreignId('subcategory_id')->nullable()->constrained('categories')->onDelete('set null')->comment('影音子分類ID');
