...
$_SESSION['CKFinder_UserRole']          = 'injerry_administrator';
$_SESSION['webCMS']['user_check']       = 'check';
$_SESSION['webCMS']['verify_code']      = md5('check');
...
$config['authentication'] = function () {
    ...
    if(!empty($_SESSION['CKFinder_UserRole'])){
        return true;
    }else{
        return false;
    }
...
$config['licenseKey']  = '*3?5-*1**-Q**J-*R**-*G**-5*Z*-3**H';
...
$config['resourceTypes'][] = array(
    ...
    'directory'         => 'files',
    'maxSize'           => 0,
    'allowedExtensions' => '7z,aiff,asf,avi,bmp,csv,doc,docx,fla,flv,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pptx,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,xls,xlsx,zip,svg,webp',
    'deniedExtensions'  => '',
    'backend'           => 'default'
);
